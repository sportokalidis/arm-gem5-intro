...
<img src=images/McPAT.png width=900 height=600/>

This is a block diagram of the McPAT framework. Rather than being hardwired to a particular simulator, McPAT
...
[2] https://www.sciencedirect.com/topics/computer-science/static-power <br/>
[3] http://www.es.ele.tue.nl/~mwijtvliet/5SIA0_MC/?page=guidelines&fbclid=IwAR05XtdziN1oVpr1GuOihbdGDdWv5qexfQoGMF_m7vLf3EsdIbpEyJycrNY <br/>
[4] https://www.hpl.hp.com/research/mcpat/ <br/>
[5] https://www.hpl.hp.com/research/mcpat/McPATAlpha_TechRep.pdf <br/>
[6] https://www.hpl.hp.com/research/mcpat/micro09.pdf <br/>
...
Η συγκεκριμένη εργασία ήταν απαιτητική όσον αφορα την κατανοηση των εννοιών, αλλά και για τη απάντηση των ερωτημάτων που απαιτουσαν κριτικη σκεψη και κατανόηση της θεωρίας. Ωστόσο, αυτο δεν ειναι αρνητικό, αφου μας βοήθησε, να εξοικιωθούμε με τα εργαλία gem5 και McPat και επιπλέον μας βάζει στη διαδικασία να ψάξουμε στη βιβλιογραφία, να διαβασουμε επιπλέον πράγματα πάνω στο θέμα, διευρίνοτας τις γνώσεις μας.       
